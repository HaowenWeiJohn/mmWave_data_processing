...
negative_rtn = False, None, None, None, None, None, None, None
        ...
        try:
            ...
            for i in range(numTLVs):
                ...
                if tlvType == 1:
                    ...
                    noise_profile = parseRangeProfile(data, tlvLength)
            ...
            return True, data, detected_points, range_profile, noise_profile, rd_heatmap, azi_heatmap, statistics
